...
const MTinjauRejectedModal = ({ onClose }) => {
      ...
      <div className="grid grid-cols-2 gap-1">
        <div className="notification__text text-start">
          <p className="text__title text-lg text-black font-bold">
            Apakah anda yakin untuk menolak <br/>dokumen ini?
          </p>
          ...
          <div className="rejected__catatan mt-4">
            <form onSubmit={handleSubmit}>
              <div className="input__catatan">
                <label htmlFor="rejected-notes" className="sr-only">
                  {" "}
                  Catatan Penolakan oleh Manajer{" "}
                </label>
                <div className="relative">
                  <textarea
                    id="rejected-notes"
                    type="text"
                    className="text-black p-4 border-2 h-32 border-gray-300 bg-white rounded-2xl w-[380px] resize-none"
              ...
              <button
                type="submit"
                className="transition duration-500 mt-4 p-2 px-8 text-base shadow-red-600 drop-shadow-md rounded-xl border-2 border-red-600 bg-red-600 text-white font-bold hover:bg-white hover:text-red-600"
              >
                Kirim Catatan
              </button>
            </form>
        ...
        <div className="notification__illustrations flex-col grid -translate-y-3">
          ...
          <div className="justify-self-center">
            <svg
              ...
              width="311.68"
              height="165.48"
              viewBox="0 0 930.67538 521.87593"
            >
              <path
                id="a08a2523-9d19-4e0c-87cb-6ce1a7fd2fc4-235"
                data-name="Path 133"
              ...
              />
              <path
                id="a62b1d0a-4504-46a8-81c8-bbc6043ad63f-236"
                data-name="Path 134"
              ...
              />
              <path
                id="fd401fbc-93ba-42a5-a9a4-5a6900171ed6-237"
                data-name="Path 133"
              ...
              />
              <path
                id="eaa08601-a63b-4214-86e2-4a8f8e2c7e12-238"
                data-name="Path 134"
              ...
              <path
                ...
                fill="#ffb6b6"
              />
              <circle cx="603.19202" cy="262.1948" r="31" fill="#e42313" />
              <path
              ...
              />
              <path
                d="M795.06648,383.9734l-8.5-6.5c-2.29817-.87172-5.44731,1.605-6,4l-12,49,25,18,3.5-5.5Z"
                transform="translate(-134.66231 -189.06204)"
                fill="#3f3d56"
              />
              <g opacity="0.2">
...
export default MTinjauRejectedModal;
