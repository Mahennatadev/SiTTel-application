...
import MReviewComp from "./MReviewComp";
import { useState } from "react";
import MCompletedNotification from "./MCompletedNotification";
import exampleDoc1 from "../Assets/exampleDoc1.png";

const MCompleteTandatangani = () => {
      ...
      <div className="doc__container mx-36 border border-gray-200 mt-8">
        ...
        <div className="doc__maincontent flex grid-cols-2">
          <div className="doc__view bg-gray-200 px-36 flex-col justify-center items-center py-8 max-h-screen overflow-y-auto relative">
            ...
            <img src={exampleDoc1} alt="docEx" className="mt-4"/>
          </div>

          <div className="doc__detail py-4 mx-auto w-[400px] items-center space-y-2">
            <div className="doc__text text-center">
              <p className="text__title text-black font-bold text-2xl">
                Selesai
              </p>
              <p className="text__subtitle">Dokumen berhasil ditandatangani</p>
            </div>

            <div className="doc__illustrations pt-8 flex items-center justify-center">
              <svg
            ...
            <div className="doc__notes pt-20">
              <p className="text-black text-center font-semibold pb-2">
                Tambahkan Catatan:
              </p>
              <form onSubmit={handleSubmit}>
                <div className="input__notes flex items-center justify-center">
                  <label htmlFor="completed__notes" className="sr-only">
                    {" "}
                    Catatan Tambahan{" "}
                  </label>
                  <div className="relative">
                    <textarea
                      id="completed__notes"
                      type="text"
                      className="text-black p-4 border-2 h-44 border-gray-300 bg-white rounded-2xl w-[380px] resize-none"
                      placeholder="Masukkan catatan anda disini"
                    />
                  </div>
                </div>

                <div className="form__button flex items-center justify-center">
                  <button
                    type="submit"
                    className="transition duration-500 mt-4 py-3 px-8 text-base shadow-red-600 w-[380px] drop-shadow-md rounded-xl border-2 border-red-600 bg-red-600 text-white font-bold hover:bg-white hover:text-red-600"
                  >
                    Kirim Catatan
                  </button>
                </div>
...
export default MCompleteTandatangani;
