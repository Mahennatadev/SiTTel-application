      ...
      <div className="grid grid-cols-2">
        <div className="modal__text text-start">
          <p className="text__title text-2xl text-black font-bold">
            Tambah Jenis Keperluan Dokumen
          </p>

          <p className="text__subtitle text-black pt-2">
            Silahkan isi keperluan baru
          </p>
              ...
              <div className="form__jenisKeperluan">
                ...
                <div className="relative">
                  <textarea
                    id="doc-type"
                    type="text"
                    className="peer w-full rounded-xl text-black border border-gray-200 p-5 h-[140px] shadow-sm bg-transparent placeholder-transparent resize-none"
                    placeholder="Jenis Keperluan Dokumen"
                    required
                  />
        ...
        <div className="modal__illustrations flex-col grid -translate-y-2">
...
export default ATambahJenisKeperluan;
